...
Rapidly build beautiful and accessible experiences. The Digital Design Library contains all the resources you need to get started.

</PageDescription>


## Resources
Not sure know to add the resource card component
...
If you are looking to get started on a page, you can make use of the **<DotcomeShell**, which is a React based UI Shell that contains the <Masthead> and the <Footer>, using Carbon's grid.
   
See it in action at https://ibmdotcom-react.netlify.com/?path=/story/dotcom-shell--default.
